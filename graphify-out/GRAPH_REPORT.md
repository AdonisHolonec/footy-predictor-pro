...
## Corpus Check
- 452 files · ~303,153 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3122 nodes · 7732 edges · 195 communities (184 shown, 11 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.52)
...
- `rebuildForLeague()` --indirect_call--> `fx()`  [INFERRED]
  scripts/rebuildElo.js → tests/ultraUniqueQuota.test.js
...
Cohesion: 0.19
Nodes (20): handleHealth(), getDailyCacheStats(), getLocalCacheStats(), buildHealthBundle(), buildOpsAlerts(), checkKv(), checkSupabase(), generateDailyReport() (+12 more)

### Community 1 - "AdminObservatory.tsx"
Cohesion: 0.05
Nodes (43): App(), AdminFilterDeck(), AdminFilterDeckProps, AdminIconRail(), AdminInsightColumnProps, AdminModelMetricsPanel(), AdminModelMetricsPanelProps, AdminObservatoryHeader() (+35 more)

### Community 2 - "Stage03LambdaGeneration.js"
Cohesion: 0.16
Nodes (19): extractAdvancedGoalsAverages(), normalizeTeamStatisticsPayload(), selectTopPickAndQuote(), buildLeagueStandingsTable(), buildStatsFromFinishedFixtures(), buildTeamContext(), fetchTeamStatisticsFromRecentFixtures(), fetchTeamStatisticsWithSeasonFallback() (+11 more)
...
Cohesion: 0.47
Nodes (7): activationFromFactor(), activationFromScore100(), computeActivations(), featureImportanceToMlVector(), moduleDetail(), moduleScore(), num()

### Community 6 - "runFixtureStageLoop.js"
Cohesion: 0.09
Nodes (39): handler(), getLeagueConfidenceMultiplier(), getLeagueParams(), getLeagueProfile(), getLeagueStakeCap(), getModelMarketBlendWeight(), buildGoldenContext(), defaultFx() (+31 more)
...
Cohesion: 0.08
Nodes (34): BacktestAnalyticsPanel(), EMPTY_METRICS, LoadableFilters, PeriodKey, BreakdownBarChart(), DailyPnlChart(), DrawdownChart(), EquityChart() (+26 more)

### Community 9 - "LandingAccess.tsx"
Cohesion: 0.12
Nodes (19): BrandArtboardProps, ModelPulseWave(), BRAND_IMAGES, LANDING_PREVIEW_LOGOS, ManagedProfile, mapSupabaseUser(), ProfileRow, sanitizeLeagueIds() (+11 more)
...
Cohesion: 0.07
Nodes (35): fmtMs(), HealthDashboard(), statusTone(), tip, widgetTone(), pct(), PerformanceApiResponse, PerformanceCounterModal() (+27 more)

### Community 12 - "BacktestAnalytics.js"
Cohesion: 0.14
Nodes (26): buildBacktestReport(), buildDashboardBundle(), buildReturnsHistogram(), clamp(), computeQuantMetrics(), confidenceDistribution(), extractBetEvent(), extractTipBetEvent() (+18 more)

### Community 13 - "useAppController.ts"
Cohesion: 0.10
Nodes (38): addCalendarDayIso(), DatePicker(), DatePickerProps, Header(), HeaderProps, ELITE_LEAGUE_META, ELITE_LEAGUES, AuthApi (+30 more)

### Community 14 - "daily-ml.js"
Cohesion: 0.10
Nodes (28): brierForSamples(), buildStackerDataset(), CALIBRATION_MIN_SAMPLES, CALIBRATION_WINDOW_DAYS, fitBestCalibration(), LEAGUE_PROFILE_MIN_SAMPLES, LEAGUE_PROFILE_SHRINKAGE_K, LEAGUE_PROFILE_WINDOW_DAYS (+20 more)
...
Cohesion: 0.08
Nodes (36): LeaguePanel(), LeaguePanelProps, LeagueSelectorProps, Props, Toast(), useHistorySync(), UseHistorySyncOptions, isTerminalOrAbandonedStatus() (+28 more)
...
Cohesion: 0.13
Nodes (52): calculateEnsembleStake(), calculateEV(), calculateKellyQuarter(), evaluateNoBetZone(), factorial(), getPoissonProbability(), attachRecommendationExplanation(), buildConfidenceEngine() (+44 more)

### Community 19 - "rebuildTeamMarketRolling.js"
Cohesion: 0.10
Nodes (35): handler(), inferSeason(), parseLeagueIds(), handler(), inferSeason(), MARKET_REFRESH_BUDGET_CALLS, MARKET_REFRESH_WINDOW_DAYS, parseLeagueIds() (+27 more)

### Community 20 - "LocaleContext.tsx"
Cohesion: 0.12
Nodes (27): ADMIN_PREDICT_FLOW_MESSAGES, msgs(), PredictFlowMessages, USER_PREDICT_FLOW_MESSAGES, LocaleContext, LocaleContextValue, LocaleProvider(), applyTheme() (+19 more)

### Community 21 - "Stage01DataCollection.js"
Cohesion: 0.10
Nodes (40): handleDay(), handler(), ACTION_LIMIT_BY_TIER, CONFIDENCE_CATEGORY_THRESHOLDS, confidenceCategory(), decrementPredictCountBy(), decrementPredictCountToday(), FREE_DAYS_LIMIT (+32 more)
...
Cohesion: 0.07
Nodes (31): AdminPerformanceObservatory(), AdminPerformanceTables(), AdminPerformanceTablesProps, AdminUsageSnapshot(), AdminUsageSnapshotProps, AdminUsersPanel(), AdminUsersPanelProps, ManagedProfile (+23 more)

### Community 25 - "history.js"
Cohesion: 0.14
Nodes (33): handleMetrics(), isAuthorizedForMetrics(), buildPerformancePayload(), fetchFixtureMarketTotals(), handleClosingOdds(), handleHistoryRead(), handleHistorySync(), handlePerformanceRead() (+25 more)

### Community 26 - "CalibrationSelector.js"
Cohesion: 0.15
Nodes (17): ApiUsageBarChart(), ConfidenceAreaChart(), heatColor(), LeagueBarChart(), LeagueMarketHeatmap(), MarketPieChart(), PerformanceRadarChart(), PIE_COLORS (+9 more)

### Community 27 - "useBacktest.ts"
Cohesion: 0.35
Nodes (10): handleAnalytics(), handleKpi(), handleModelLab(), handlePublicTrack(), handler(), handleSnapshot(), handleWalkForwardTip(), betsToCsv() (+2 more)
...
Cohesion: 0.09
Nodes (27): ExplanationCard(), isFormReason(), polarityClass(), barColor(), FeatureImportanceChart(), MonteCarloPanel(), Props, tip (+19 more)

### Community 31 - "fitStacker.js"
Cohesion: 0.07
Nodes (56): buildDataset(), MIN_SAMPLES_GLOBAL, MIN_SAMPLES_LEAGUE, oneHot(), run(), SGD_OPTS, upsertWeights(), WF_FOLDS (+48 more)

### Community 32 - "getSupabaseAdmin"
Cohesion: 0.23
Nodes (13): handleClaimBootstrapAdmin(), parseAdminEmailsFromEnv(), persistContextSnapshots(), computeRefereeStatsFromHistory(), envInt(), FINAL_STATUSES, FeatureImportanceEngine, persistFeatureImportanceRows() (+5 more)
...
Cohesion: 0.15
Nodes (24): applyCalibratedBinary(), applyCalibratedTriple(), applyIsotonicMap(), applySideMarketCalibration(), cachedMaps, pickCalibrationMapForLeague(), applyLeagueMarketPriors(), advancedLambdas() (+16 more)
...
Cohesion: 0.21
Nodes (23): appOrigin(), attachJsonBody(), config, handleCheckout(), handleConfig(), handlePortal(), handler(), handleTrial() (+15 more)

### Community 40 - "math.test.js"
Cohesion: 0.21
Nodes (14): blendModelWithMarket(), applyStacker(), cached, clamp01(), extractStackerFeatures(), pickStackerWeightsForLeague(), safeLog(), softmax3() (+6 more)
...
Cohesion: 0.19
Nodes (20): attachCardMarketsToPayload(), deriveAlignedOuPick(), deriveBestGoalsPick(), deriveBestOverUnderPick(), deriveCardMarketPicks(), evaluateOuLine(), evaluateTopPick(), FINAL_STATUSES (+12 more)

### Community 44 - "Stage04ProbabilityGeneration.js"
Cohesion: 0.17
Nodes (18): deriveEloInfo(), buildPipelineTrace(), LAMBDA_TRACE_STAGE_IDS, cachedElo, eloExpectedHomeScore(), eloKFactor(), eloProbabilities(), lookupEloPair() (+10 more)
...
Cohesion: 0.09
Nodes (26): APP_NAV_ITEMS, AppNavView, MatchesSubFilter, MOBILE_TAB_ITEMS, Props, Props, Props, confOf() (+18 more)

### Community 48 - "TipEvent.js"
Cohesion: 0.22
Nodes (15): handleClv(), selectionClosingOdd(), buildClvReport(), computeClvPct(), mean(), median(), monthKey(), num() (+7 more)

### Community 49 - "overlayStore.js"
Cohesion: 0.18
Nodes (19): clearRuntimeOverlays(), overlaysEnabled(), refreshAutoCalibrationOverlays(), runtime, setRuntimeOverlays(), cache, cacheKey(), filePath() (+11 more)
...
Cohesion: 0.21
Nodes (19): computeMixMetrics(), applyInjuries(), argmax(), blendModel(), blendSources(), evaluateModel(), getModelById(), homeAdvElo() (+11 more)

### Community 54 - "usePerformanceTracker.ts"
Cohesion: 0.18
Nodes (14): ExcludedLossDay, healthToneClass(), ModelHealthSummary, SuccessRateTracker(), SuccessRateTrackerProps, isCompactViewport(), usePerformanceTracker(), LoadHistoryResult (+6 more)
...
Cohesion: 0.13
Nodes (15): HistorySection(), Props, rowKey(), toneFor(), Props, StatisticsSection(), TrackRecordSection, Card() (+7 more)
...
Cohesion: 0.32
Nodes (9): asNum(), handler(), reasonCodesFromRow(), buildEmailHtml(), getUserEmail(), handler(), sendEmail(), isAuthorizedCronOrInternalRequest() (+1 more)
...
Cohesion: 0.35
Nodes (7): parseAdminEmails(), readBearer(), todayCalendarEuropeBucharest(), halt(), run(), peekWarmPredictUsage(), rollbackPredictIncrement()
...
Cohesion: 0.22
Nodes (15): handleModelSelect(), BlendRecipeSelection, envNum(), getActiveModel(), getActiveModelId(), kv, minSamples(), normalize() (+7 more)
...
Cohesion: 0.16
Nodes (21): buildCalibrationGroups(), fetchContextSnapshots(), mergeSnapshotIntoEngineCtx(), newAggregate(), oddsForPick(), pickFromProbs(), reconstructEngineCtx(), recordFixture() (+13 more)
...
Cohesion: 0.39
Nodes (6): extractResult(), fetchFixturesForLeagueSeason(), rebuildForLeague(), run(), UPSTREAM, persistEloMap()
...
Cohesion: 0.18
Nodes (26): buildCacheKey(), buildFetchUrl(), buildLegacyCacheKey(), bumpDailyCacheStats(), getDateISOWithOffset(), getTodayISO(), getUpstreamProvider(), getWithCache() (+18 more)
...
Cohesion: 0.31
Nodes (14): buildCalibrationReport(), clamp(), computeBrier1x2(), computeEce(), computeReliabilityBuckets(), extractSamplesFromHistory(), fitAutoCalibrationOverlays(), fitFeatureWeightDeltas() (+6 more)
...
Cohesion: 0.28
Nodes (15): bumpFailure(), emptyChannel(), emptyDayMetrics(), getOpsMetrics(), getOpsMetricsHistory(), kv, percentile(), pushSample() (+7 more)
...
Cohesion: 0.14
Nodes (24): camelToEnvSuffix(), envSet(), getConfidenceManualLocks(), getFeatureImportanceManualLocks(), getPredictionManualLocks(), getValueManualLocks(), locksForKind(), applyWeightDeltas() (+16 more)
...
## Knowledge Gaps
- **1129 isolated node(s):** `config`, `CALIBRATION_MIN_SAMPLES`, `CALIBRATION_WINDOW_DAYS`, `STACKER_MIN_LEAGUE`, `STACKER_MIN_GLOBAL` (+1124 more)
...
- **Why does `useWarm()` connect `useWarm.ts` to `ml/index.js`, `useAppController.ts`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `getSupabaseAdmin()` connect `getSupabaseAdmin` to `healthBundle.js`, `Stage03LambdaGeneration.js`, `ml/index.js`, `closingOddsCapture.js`, `runFixtureStageLoop.js`, `daily-ml.js`, `Stage02FeatureCollection.js`, `rebuildTeamMarketRolling.js`, `Stage01DataCollection.js`, `LeagueProfile.js`, `history.js`, `useBacktest.ts`, `admin.js`, `fixtures.js`, `Stage05Simulation.js`, `billing.js`, `math.test.js`, `Stage04ProbabilityGeneration.js`, `TipEvent.js`, `overlayStore.js`, `isAuthorizedCronOrInternalRequest`, `isotonicCalibration.js`, `api/backtest.js`, `rebuildElo.js`, `AutoCalibrationEngine.js`?**

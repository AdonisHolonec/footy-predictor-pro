  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      if (mode === "login") {
        ...
        setLocalSuccess("Parola a fost actualizata. Sesiunea ta este activa.");
        // User is already authenticated after resetPassword; close the modal so they
        // land directly in the workspace instead of being asked to log in again.
        setPassword("");
        setConfirmPassword("");
        onClose();
      }

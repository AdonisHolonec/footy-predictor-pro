        ...
        <header className="sticky top-0 z-40 border-b border-white/[0.08] bg-signal-mist/70 px-4 py-3 backdrop-blur-xl sm:px-6">
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
            ...
            <Link
              ...
              className={`rounded-xl border border-signal-petrol/50 bg-signal-petrol/20 px-4 py-2 font-mono text-[11px] font-semibold uppercase tracking-wider text-signal-petrol transition hover:bg-signal-petrol/30 ${loading ? "pointer-events-none opacity-60" : ""}`}
            >
              {loading ? "Checking..." : user ? "Open App" : "Sign In"}
            </Link>
          </div>
        </header>

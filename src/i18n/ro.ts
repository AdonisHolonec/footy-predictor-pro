...
export const ro: Dict = {
  ...
  dash: {
    ...
    marketFilterLabel: "Sortează după șansa pieței",
    marketFilterTitle: "Cele mai mari șanse: {label}",
    marketGg: "GG",
    marketO15Ft: "+1.5 FT",
    marketO25Ft: "+2.5 FT",
    marketO15Fh: "+1.5 FH",
    marketGgName: "Ambele marchează (GG)",
    marketO15FtName: "Peste 1.5 goluri, final",
    marketO25FtName: "Peste 2.5 goluri, final",
    marketO15FhName: "Peste 1.5 goluri, prima repriză",
    marketProbability: "șansă",
    emptyMarketTitle: "Nicio șansă pentru {label}",
    emptyMarketDesc: "Meciurile din listă nu au o probabilitate calculată pentru această piață. Alege altă piață sau vezi toată lista.",
    ...
    matchesAnalyzed: "{n} meciuri analizate",
    ...
    predictPromoTitle: "Predicțiile tale se pregătesc",
    predictPromoBody: "Între timp, poți câștiga 5 zile Ultra gratuit: recomandă Footy Predictor unui prieten.",
    predictPromoCta: "Recomandă un prieten",
    predictPromoLater: "Mai târziu",
  ...
  account: {
    referral: {
      ...
      description:
        "Trimite-i linkul tău. După ce își confirmă emailul și face prima predicție, primiți amândoi {days} zile Ultra.",
      codeLabel: "Codul tău",
      linkLabel: "Linkul tău",
      copy: "Copiază linkul",
      copied: "Link copiat",
      copyFailed: "Nu am putut copia linkul. Selectează-l manual.",
      share: "Trimite invitația",
      successful: "Recomandări reușite",
      pending: "{n} în așteptare",
      earned: "Zile Ultra câștigate",
      capRemaining: "Invitații până la limită",
      capReached: "Limita de recompense a fost atinsă.",
      capReachedHint: "Prietenii tăi primesc în continuare {days} zile Ultra.",
      inviteTitle: "Ai fost invitat de un prieten",
      inviteBody: "Acceptă invitația și, după ce îți confirmi emailul și faci prima predicție, primiți amândoi {days} zile Ultra.",
      inviteOnce: "Poți folosi o singură invitație.",
      ...
      stateRewarded: "{days} zile Ultra active",
      stateExpired: "Invitația a expirat",
      loading: "Se încarcă…",
      errorGeneric: "Ceva nu a mers. Încearcă din nou.",
      errorUnauthenticated: "Autentifică-te pentru a folosi invitațiile.",
      errorInvalidCode: "Codul de invitație nu este valid.",
      errorAlreadyAttributed: "Ai folosit deja o invitație.",
    ...
    header: {
      ...
      trialActive: "Trial activ",
      tierActive: "Acces activ",
      ...
      quotaLeftOne: "{count} predicție azi",
      quotaLeftFew: "{count} predicții azi",
      quotaLeftOther: "{count} de predicții azi",
      planAria: "Plan {tier}",
      spokenDayOne: "{count} zi",
      spokenDayFew: "{count} zile",
      spokenDayOther: "{count} de zile",
      spokenHourOne: "{count} oră",
      spokenHourFew: "{count} ore",
      spokenHourOther: "{count} de ore",
      spokenMinuteOne: "{count} minut",
      spokenMinuteFew: "{count} minute",
      spokenMinuteOther: "{count} de minute",
      unitDay: "z",
      unitHour: "h",
      unitMinute: "m"
    },
  ...
  auth: {
    ...
    referralCodeLabel: "Cod de recomandare (opțional)",
    referralCodePlaceholder: "ex. ABCD234567",
    referralCodeHint: "Dacă un prieten ți-a trimis un cod, adaugă-l aici. Invitația se confirmă după autentificare.",
    referralCodeFromLink: "Preluat din linkul de invitație. Îl poți lăsa așa.",
    referralCodeReplaces: "Va înlocui codul preluat din linkul de invitație.",
    referralCodeInvalidMsg: "Codul de recomandare nu are formatul corect (10 caractere, litere și cifre).",

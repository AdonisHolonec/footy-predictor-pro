...
export const en: Dict = {
  ...
  dash: {
    ...
    marketFilterLabel: "Sort by market chance",
    marketFilterTitle: "Highest chance: {label}",
    marketGg: "GG",
    marketO15Ft: "+1.5 FT",
    marketO25Ft: "+2.5 FT",
    marketO15Fh: "+1.5 FH",
    marketGgName: "Both teams to score (GG)",
    marketO15FtName: "Over 1.5 goals, full time",
    marketO25FtName: "Over 2.5 goals, full time",
    marketO15FhName: "Over 1.5 goals, first half",
    marketProbability: "chance",
    emptyMarketTitle: "No chance available for {label}",
    emptyMarketDesc: "None of the listed matches carry a probability for this market. Pick another market or see the full list.",
    ...
    matchesAnalyzed: "{n} matches analyzed",
    billingSuccess: "Payment successful. Your subscription activates in a few seconds.",
    billingCancelled: "Checkout cancelled.",
    rehydratedLabel: "Saved picks updated.",
    ...
    predictPromoTitle: "Your predictions are being prepared",
    predictPromoBody: "Meanwhile, earn 5 free Ultra days: recommend Footy Predictor to a friend.",
    predictPromoCta: "Recommend a friend",
    predictPromoLater: "Later",
    ...
    subscriptionSub: "Premium (25 matches · 20 predictions a day) or Ultra (50 unique · 50 predictions a day). You can pay during a trial.",
  ...
  card: {
    ...
    hot: "HOT",
    topPick: "Top pick",
    specialBet: "Build ticket · Top signals",
    specialBetLocked: "Tickets are available on the Ultra plan.",
    legs: "{n} legs",
  ...
  match: {
    ...
    noStandingsBody: "Standings and form are not available for this match.",
    ...
    cards: "Cards",
    dcSubtitle: "Two outcomes covered in one pick.",
    htSubtitle: "Goals before the break",
    cornersSub: "Over / Under totals",
    ...
    sampleHome: "home sample · {n}",
    sampleAway: "away sample · {n}",
    leagueAverage: "league average · {n}",
    sampleFallback: "⚠ league average used — team data incomplete",
  ...
  landing: {
    ...
    ultraM5: "Full value (EV / Kelly) + tickets",
  ...
  tickets: {
    ...
    // The two products under Tickets. "Global Bets" is bet_type = GLOBAL,
    // generated by the product and read-only here; "My Bets" is the user's own.
    globalBetsTab: "Global Bets",
    myBetsTab: "My Bets",
    globalBetsTitle: "Global Bets",
    globalBetsSub: "Tickets published by Footy Predictor, built from every league we cover.",
    globalBetsEmpty: "No published Global Bets yet",
    globalBetsEmptyDesc: "When we publish a Global Bet it will appear here.",
    globalBetsError: "We could not load Global Bets. Try again.",
    myBetsTitle: "My Bets",
  ...
  account: {
    referral: {
      ...
      description:
        "Send them your link. Once they confirm their email and make their first prediction, you both get {days} Ultra days.",
      codeLabel: "Your code",
      linkLabel: "Your link",
      copy: "Copy link",
      copied: "Link copied",
      ...
      pending: "{n} pending",
      earned: "Ultra days earned",
      capRemaining: "Invites remaining",
      capReached: "Reward limit reached.",
      capReachedHint: "Your friends still receive {days} Ultra days.",
      inviteTitle: "A friend invited you",
      inviteBody: "Accept the invitation and, once you confirm your email and make your first prediction, you both get {days} Ultra days.",
      inviteOnce: "You can only use one invitation.",
      ...
      stateRewarded: "{days} Ultra days active",
      stateExpired: "The invitation expired",
      loading: "Loading…",
      errorGeneric: "Something went wrong. Try again.",
      errorUnauthenticated: "Sign in to use invitations.",
      errorInvalidCode: "That invitation code is not valid.",
      errorAlreadyAttributed: "You have already used an invitation.",
    ...
    header: {
      ...
      quotaLeftOne: "{count} prediction today",
      quotaLeftFew: "{count} predictions today",
      quotaLeftOther: "{count} predictions today",
      planAria: "{tier} plan",
      spokenDayOne: "{count} day",
      spokenDayFew: "{count} days",
      spokenDayOther: "{count} days",
      spokenHourOne: "{count} hour",
      spokenHourFew: "{count} hours",
      spokenHourOther: "{count} hours",
      spokenMinuteOne: "{count} minute",
      spokenMinuteFew: "{count} minutes",
      spokenMinuteOther: "{count} minutes",
      unitDay: "d",
      unitHour: "h",
      unitMinute: "m"
    },
  ...
  detail: {
    whyTitle: "Why this pick",
    whyUnavailable: "The model has no single decisive reason for this pick.",
    whyFactors: "Key factors",
    whyDeep: "Full explanation",
    liveTitle: "Live",
    liveRecent: "Recent",
    eventsTitle: "Events",
    ...
    marketsSub: "Goals · Corners · Shots · Cards",
    oddsValue: "Odds & value",
    ticketTitle: "Build a 2–3 leg ticket",
    ticketPreview: "{n} legs · combined {odd}",
    ticketNone: "Not enough strong signals for a ticket on this match.",
    contextTitle: "Context",
    contextSub: "Form · Standings · Conditions",
    conditionsTitle: "Conditions",
    advancedTitle: "Model internals",
  ...
  history: {
    ...
    daySummary: "{settled} settled · {won} won · {lost} lost · {rate}%",
    dayPending: "{n} pending",
    ticketResults: "Ticket results",
    emptyDayTitle: "No predictions on this day",
    emptyDayDesc: "Step back a day to see earlier results.",
    emptyFilteredTitle: "Nothing with this outcome",
    emptyFilteredDesc: "Other outcomes exist for this day — show all.",
    eyebrow: "History",
    title: "History",
    ...
    selectedMatch: "Ticket · selected match",
    clearSelection: "Close",
    confidence: "Confidence {value}",
    specialBetNoLegs: "Not enough bookmaker odds for a multi-leg ticket on this match.",
    openFullAnalysis: "Open full analysis"
  },
  panels: {
    keyFactors: "Key factors",
    keyFactorsSub: "What moved this prediction",
    confidence: "Confidence",
    ...
    whyPredictionSub: "Signed impact on pick {pick}",
  ...
  auth: {
    ...
    referralCodePlaceholder: "e.g. ABCD234567",
    referralCodeHint: "If a friend sent you a code, add it here. The invitation is confirmed after you sign in.",
    referralCodeFromLink: "Taken from the invitation link. You can leave it as it is.",
    referralCodeReplaces: "This will replace the code taken from the invitation link.",
    referralCodeInvalidMsg: "The referral code is not in the right format (10 characters, letters and digits).",
  ...
  gsb: {
    ...
    noFavoritesDesc:
      "Tickets are built from your favorite leagues. Pick at least one in the league selector.",
    emptyTitle: "No ticket yet",
    emptyDesc: "Choose a variant and generate your first multi-match selection.",
    errorTitle: "Could not build your ticket",
    errorDesc: "The server ran into a problem. Please try again.",
    errorAuthTitle: "Session expired",
    errorAuthDesc: "Sign in again to build a ticket.",
    ...
    errorConflictDesc: "A ticket already exists for this day and variant.",
    retry: "Retry",
    lockedTitle: "Tickets",
    lockedDesc: "Tickets are available on the Ultra plan.",
    unlock: "Unlock",
    // The Tickets section: two products, two tabs, two distinct empty states —
    // "no combos" and "no systems" are different facts.
    ticketsTitle: "Tickets",
    ticketsSub: "Your tickets, split into Combo and System.",

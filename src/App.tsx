      ...
      <div className="mx-auto max-w-[1600px] px-4 py-8 lg:px-6">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between mb-8">
          <div className="min-w-0">
              ...
              <div className="relative mt-4 w-full max-w-[760px] rounded-2xl border border-cyan-400/20 bg-gradient-to-br from-slate-900/90 via-slate-900/80 to-slate-950/90 px-2.5 sm:px-4 py-3 shadow-[0_0_40px_rgba(16,185,129,0.08)] overflow-hidden">
                ...
                <div className="relative text-center mb-2">
                  <div className="text-[9px] sm:text-[11px] uppercase tracking-[0.16em] sm:tracking-[0.2em] text-slate-300 font-black">Football Predictions - Performance Counter</div>
                ...
                <div className="relative grid grid-cols-3 gap-1.5 sm:gap-3">
                  <div className="rounded-lg sm:rounded-xl border border-emerald-400/40 bg-emerald-500/10 px-2 sm:px-3 py-2 shadow-[0_0_20px_rgba(16,185,129,0.18)]">
                    <div className="text-[8px] sm:text-[10px] uppercase tracking-wider sm:tracking-widest text-emerald-200/90 font-black">Wins ✅</div>
                    <div className="mt-1 text-xl sm:text-2xl font-black text-emerald-300 leading-none">{animatedWins}</div>
                    <div className="mt-1 text-[8px] sm:text-[10px] uppercase tracking-wider sm:tracking-widest text-emerald-300/70 font-black">Total</div>
                  </div>
                  <div className="rounded-lg sm:rounded-xl border border-rose-400/40 bg-rose-500/10 px-2 sm:px-3 py-2 shadow-[0_0_20px_rgba(244,63,94,0.16)]">
                    <div className="text-[8px] sm:text-[10px] uppercase tracking-wider sm:tracking-widest text-rose-200/90 font-black">Losses ❌</div>
                    <div className="mt-1 text-xl sm:text-2xl font-black text-rose-300 leading-none">{animatedLosses}</div>
                    <div className="mt-1 text-[8px] sm:text-[10px] uppercase tracking-wider sm:tracking-widest text-rose-300/70 font-black">Total</div>
                  </div>
                  <div className={`rounded-lg sm:rounded-xl border border-cyan-400/40 bg-cyan-500/10 px-2 sm:px-3 py-2 shadow-[0_0_20px_rgba(34,211,238,0.18)] transition-all duration-500 ${isWinRatePulsing ? "scale-[1.02] shadow-[0_0_26px_rgba(34,211,238,0.35)]" : ""}`}>
                    <div className="text-[8px] sm:text-[10px] uppercase tracking-wider sm:tracking-widest text-cyan-200/90 font-black">Rate 🎯</div>
                    <div className="mt-1 text-xl sm:text-2xl font-black text-cyan-200 leading-none">{animatedWinRate.toFixed(1)}%</div>

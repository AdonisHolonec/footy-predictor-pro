...
export default function CollapsiblePanel({
  ...
  return (
    ...
    >
      <button
        type="button"
        className={`flex w-full items-center justify-between gap-2 text-left transition-colors duration-[var(--fp-ease)] hover:bg-[var(--fp-bg-muted)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--fp-accent)] ${
